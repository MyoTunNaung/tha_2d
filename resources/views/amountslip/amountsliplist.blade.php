...
<div class="col-md-6">
  ...
  <div class="card-header">
      ...
      <form method="get" action="{{ url("/slip/list/show") }}" enctype="multipart/form-data">
                      ...
                      @foreach($users as $key => $user_id)
                          ...
                          <?php
                              ...
                              $p_slips   = ThreePosition::leftJoin('users', 'three_positions.user_id', '=', 'users.id')
                                ...
                                $threed_comm = Commission::where('user_id','=',$user_id)->value('twod_comm');
