...
class ListController extends Controller
{
    ...
    public function showList()
    {
        ...
        if($action == "2D")
        {
            ...
            // $total_purchase     =   DB::table('twos')->sum('purchase_amount');
    ...
    public function showMain()
    {
        ...
        $work_file_id   = Choice::where('auth_id','=',auth()->user()->id)->value('work_file_id');  
            ...
            // dd("$from_date / $to_date / $total_sale ");
            ...
            else
            {
                ...
                $total_digit_amount     =   Result::leftJoin('users', 'results.user_id', '=', 'users.id')
                                                ->leftJoin('work_files', 'results.work_file_id', '=', 'work_files.id')

                                                ->where([
                                           
                                                            ["results.user_id","$user_op",$user_id],
                                                            ['users.in_out', "$inout_op", $in_out],
                ...
                {
                    $total_compensation     = ($total_digit_amount * $w_times) ;
                }
                else
                {
                    $total_compensation     = 0;
